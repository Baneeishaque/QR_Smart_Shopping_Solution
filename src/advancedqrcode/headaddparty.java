 ...
 * @author junais
 */
public class headaddparty extends javax.swing.JFrame {

    /**
     * Creates new form headaddparty
     */
    public headaddparty() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("ENTER PARTY DETAILS");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(pin)
                    .addComponent(phone)
                    .addComponent(partyname, javax.swing.GroupLayout.DEFAULT_SIZE, 512, Short.MAX_VALUE)
                    .addComponent(place)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ...
            String a=partyname.getText().toString();
            String b=place.getText().toString();
            String c=address.getText().toString();
            String d=pin.getText().toString();
            String e=phone.getText().toString();
           
            String h=emailaddress.getText().toString();
            qrdb qd=new qrdb();                     
     try {       
            Connection con=qd.getc();
            Statement st=con.createStatement();
            String st1="INSERT INTO `party`(`Name`, `Place`, `Address`, `PIN`, `Phone`, `emailaddress`) VALUES ('"+a+"','"+b+"','"+c+"','"+d+"','"+e+"','"+h+"')";
            ...
            Logger.getLogger(headaddparty.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(headaddparty.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
